                ...
                <div class=" bg-white border-b border-gray-200">
                    <div class=" p-6 grid grid-cols-3">
                        <form action="/siswa" method="post">
                            ...
                            <input name="nama_siswa" type="text" class=" w-full py-1 rounded-md" placeholder=" masukan nama lengkap" required>
                            ...
                            <input name="tempat_lahir" type="text" class=" w-full py-1 rounded-md" placeholder=" masukan nama tempat Lahir" required>
