                ...
                <div class="p-4 bg-white border-b border-gray-200">
                    ...
                    <div id="div1" class=" grid grid-cols-1">
                        ...
                        <div class=" grid grid-cols-2 py-2">
                            <div class=" border px-2">Nomor Induk Siswa</div>
                            <div class=" border px-2">: 202210100002</div>
                            <div class=" border px-2">Nama Lengkap</div>
                            <div class=" border px-2">: {{$siswa->nama_siswa}}</div>
                            <div class=" border px-2" class=" w-1/2">Jenis Kelamin</div>
                            <div class=" border px-2">: {{$siswa->jenis_kelamin}}</div>
                            <div class=" border px-2" class=" w-1/2">Agama</div>
                            <div class=" border px-2">: {{$siswa->agama}}</div>
                            <div class=" border px-2" class=" w-1/2">Tempat,Tanggal Lahir</div>
                            <div class=" border px-2">: {{$siswa->tempat_lahir}},{{$siswa->tanggal_lahir}}</div>
